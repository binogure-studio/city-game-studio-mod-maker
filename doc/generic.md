...
| [recruitment](#recruitment)       | `object` | Optional | cannot be null | [Create a mod](generic-properties-root-add-a-famous-developer.md "mod.json#/properties/recruitment")                         |
...
To manipulate concurrents games

`concurrentgame`

*   is optional

*   Type: `object` ([Root: Add/rename competitors games](generic-properties-root-addrename-competitors-games.md))

*   cannot be null

*   defined in: [Create a mod](generic-properties-root-addrename-competitors-games.md "mod.json#/properties/concurrentgame")
...
*   defined in: [Create a mod](generic-properties-root-add-a-famous-developer.md "mod.json#/properties/recruitment")
